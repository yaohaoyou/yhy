...
const ull bs=173,bss=31ull,b2=57432896ull,bs2=79843276894ull;
int n,q;
...
struct BIT{
    ...
    inline void add(int x,int s){x--;for(;x<siz;x|=x+1)tr[x]+=s;}
    inline int query(int x){int res=0;for(;x--;x&=x+1)res+=tr[x];return res;}
