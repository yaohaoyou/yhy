...
using namespace std;
const int maxn=100+10,dir[4][2]={{-1,-1},{-1,0},{0,-1},{0,0}};
bool out;
int n,m,cnt;
queue<pii> q;
bool st[maxn][maxn];
char a[maxn][maxn];
inline ll H(ll x,int y){return (x<<20)|y;}
...
void matt(int _cases){
    scanf("%d%d",&n,&m);queue<pii>().swap(q);cnt=out=0;mems(st,0);
