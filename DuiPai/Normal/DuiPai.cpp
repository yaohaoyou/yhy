...
//    freopen("DuiPai.txt","w",stdout);
    ...
    system("g++ D:\\yhy\\DuiPai\\Normal\\make_data.cpp -o D:\\yhy\\DuiPai\\Normal\\make_data.exe -O2 -std=c++14 -static -w");
    system("g++ D:\\yhy\\DuiPai\\Normal\\std.cpp -o D:\\yhy\\DuiPai\\Normal\\std.exe -O2 -std=c++14 -static -w");
    system("g++ D:\\yhy\\DuiPai\\Normal\\mine.cpp -o D:\\yhy\\DuiPai\\Normal\\mine.exe -O2 -std=c++14 -static -w");
